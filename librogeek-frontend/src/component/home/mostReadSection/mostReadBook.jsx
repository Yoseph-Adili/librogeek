...
const MostReadBook = ({book_cover, book_id}) => {
    ...
    const [coverLeftColor, setCoverLeftColor] = useState("");
    ...
    function getBookColor() {
        ...
        img.onload = function () {
            ...
            setCoverLeftColor(darken(r, g, b, 0.90));
    ...
    function darken(r, g, b, factor = 0.7) {
        ...
        >
            ...
            >
                ...
                <svg className="book-left" viewBox="0 0 58 449" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect width="100%" height="100%" fill={coverLeftColor}/>
                    <path
