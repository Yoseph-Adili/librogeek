...
const Orders = () => {
    ...
    return (
        <div className={"orders-page-container"}>
            <form action="" className={"order-search-form"}  onSubmit={(e) => e.preventDefault()}>
                ...
                <svg viewBox="0 -0.5 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path fillRule="evenodd" clipRule="evenodd"
                              ...
                              stroke="var(--text-color)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                        <path
