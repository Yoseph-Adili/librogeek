...
const EditBook = () => {
    ...
    function editBook(e) {
        ...
        const book_type = formData.get("book_type");
        const price = parseFloat(formData.get("price"));
        if (!title || !author || !description || !category || !book_type || isNaN(price)) {
    ...
    return (<div className={"edit-book-page-container"}>
        <div className="book-info-container">
            ...
            <form className="book-info edit-form" onSubmit={editBook}>
                ...
                <p>Description</p>
                <textarea value={book.description} cols="30" rows="10" name={"description"}></textarea>
                <div style={{'--i': 3}} className="type-container">
                    ...
                    <div className="type">
                        <p>Type</p>
                        <input type="text" value={book.book_type} name={"book_type"}/>
