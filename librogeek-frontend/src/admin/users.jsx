...
import UserItem from "./component/users/userItem.jsx";
...
const Users = () => {
    ...
    useEffect(() => {
        ...
        const url = `${API_URL}/users/${searchQuery.trim() ? "getAllSearchUsers" : "getAllUsers"}?${params.toString()}`;
    ...
    return (
        <div className={"users-page-container"}>
            ...
            <form action="" className={"user-search-form"} onSubmit={(e) => e.preventDefault()}>
